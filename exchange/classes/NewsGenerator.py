...
class NewsGenerator:
    ...
    def generate_news(self, temperature=1.0, top_p=1.0, max_tokens=100):
        """
        Generates a *headline* about the given topic using Cerebras.
        Sometimes it's clearly bullish/bearish, other times ambiguous.
        """
            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "other times make it uncertain or mixed. Reply ONLY with a single news headline. No explanations, no reasoning, no commentary."
                    )
                },
    ...
    def parse_news(self, news, max_tokens=100):
        ...
        Returns a float in range [-1.0, 1.0], where:
        ...
        try:
            ...
            # fallback if the model strays from instruction
